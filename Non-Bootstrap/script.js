...
const gender = 'Male' // Default gender of main person is Male
...
//Function will return values of certain comments that will change based on the main person's gender
function gender_discrepancy(male_comment, female_comment) {
    let comment;
    if (gender == 'Male') {
        comment = male_comment;
    }
    else {
        comment= female_comment;
    }
    return comment
}
...
main_answer.addEventListener('keyup', (e) => {
    if (e.keyCode == 13) {
        ...
        main_answer.style = "color: #e2f3f5; background-color: #446491;";
